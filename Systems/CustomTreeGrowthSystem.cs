...
namespace OnlyAdultTrees.Systems
{    
    [CompilerGenerated]
    public class CustomTreeGrowthSystem : GameSystemBase
    {
        ...
        private CustomTreeGrowthSystem.TypeHandle __TypeHandle;
        ...
        protected override void OnUpdate( )
        {
            ...
            JobHandle producerJob = new CustomTreeGrowthSystem.TreeGrowthJob( )
            {
            ...
            }.ScheduleParallel<CustomTreeGrowthSystem.TreeGrowthJob>( m_TreeQuery, Dependency );
